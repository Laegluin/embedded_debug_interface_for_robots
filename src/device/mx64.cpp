...
static std::array<ControlTableField, 52> FIELDS{
    ControlTableField::new_uint16(0, "Model Number", Mx64ControlTable::MODEL_NUMBER, to_string),
    ...
    ControlTableField::new_uint16(38, "Current Limit", 1941, to_string),
    ControlTableField::new_uint32(40, "Acceleration Limit", 32767, to_string),
    ControlTableField::new_uint32(44, "Velocity Limit", 285, to_string),
...
std::vector<std::pair<const char*, std::string>> Mx64ControlTable::fmt_fields() const {
